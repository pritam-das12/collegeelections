...
import { User, Star, Award, Users, ChevronDown, ChevronUp, X } from 'lucide-react';
...
export const Candidates: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="candidates" className="py-20 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="section-title text-4xl md:text-6xl font-bold text-slate-800 mb-6">
            Meet Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Candidates</span>
          </h2>
          <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            Get to know the passionate leaders from NIT Durgapur who want to represent you and drive positive change in our college community.
          </p>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center space-x-2 text-slate-600">
                    ...
                    <span className="text-sm font-medium">{candidate.department}</span>
                  </div>
                  <div className="flex items-center space-x-2 text-slate-600">
                ...
                <div className={`h-1 bg-gradient-to-r ${candidate.color} rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}></div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 shadow-2xl text-white max-w-4xl mx-auto">
            ...
            <button className="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-bold rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg">
              Join Our Movement
            </button>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="relative">
              {/* Header */}
              <div className={`bg-gradient-to-r ${selectedCandidate.color} p-8 text-white relative overflow-hidden`}>
                <button
                  onClick={closeModal}
                ...
                <div className="flex items-center space-x-6">
                  ...
                  />
                  <div>
                    <h2 className="text-3xl font-bold mb-2">{selectedCandidate.name}</h2>
                    <p className="text-xl opacity-90 mb-1">{selectedCandidate.position}</p>
                    <p className="opacity-80">{selectedCandidate.department} • {selectedCandidate.year}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8">
                <div className="prose prose-lg max-w-none">
                  {selectedCandidate.fullProfile.split('\n').map((paragraph, index) => (
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <div className="flex items-center justify-center space-x-4">
                    ...
                    <button className={`px-8 py-3 bg-gradient-to-r ${selectedCandidate.color} hover:opacity-90 text-white font-semibold rounded-xl transition-all duration-200 transform hover:scale-105`}>
