  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.hero-cta',
        { scale: 0, opacity: 0 },
        { scale: 1, opacity: 1, duration: 0.6, delay: 1.2, ease: "back.out(1.7)" }
      );
    ...
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        ...
        <p className="hero-subtitle text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
          Join the democratic process that shapes student life. Meet the candidates, 
          explore their vision, and make your voice heard in the 2025 Gymkhana Elections.
        </p>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="scroll-indicator text-white/70 flex flex-col items-center cursor-pointer" onClick={scrollToCandidates}>
